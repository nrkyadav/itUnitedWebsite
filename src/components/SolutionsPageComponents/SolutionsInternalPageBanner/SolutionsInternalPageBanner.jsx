...
import styles from "./SolutionsInternalPageBanner.module.css";
import { Swiper, SwiperSlide } from "swiper/react";
import { Autoplay } from "swiper/modules";

const SolutionsInternalPageBanner = ({ title, description, stats, image }) => {
    const logos = [
            ...
            <div className={styles.container}>
                ...
                <div className={styles.leftContainer}>
                    <div className={styles.breadcrumb}>
                        ...
                        <Link href="/dedicated-development-teams">Dedicated Teams</Link>
                        <ChevronRight size={16} />
                        <span>{title}</span>
                    </div>
...
export default SolutionsInternalPageBanner;
