...
import styles from "./IndustriesInternalPageBanner.module.css";
import { Swiper, SwiperSlide } from "swiper/react";
import { Autoplay } from "swiper/modules";

const IndustriesInternalPageBanner = ({ title, description, stats, image }) => {
    const logos = [
...
export default IndustriesInternalPageBanner;
